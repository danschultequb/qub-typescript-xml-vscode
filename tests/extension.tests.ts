...
suite("Extension", () => {
    ...
    suite("on document opened", () => {
        test("with non-xml document", () => {
            ...
            const openedDocument = new qubvscodemock.TextDocument("html", "mock-uri", "I'm not XML!");
        ...
        test("with xml document without declaration or DOCTYPE", () => {
            ...
            const openedDocument = new qubvscodemock.TextDocument("xml", "mock-uri", "");
            platform.openTextDocument(openedDocument);
        ...
        test("with xml document with declaration but not DOCTYPE", () => {
            ...
            const openedDocument = new qubvscodemock.TextDocument("xml", "mock-uri", `<?xml version="1.0" ?>`);
            platform.openTextDocument(openedDocument);
        ...
        test("with xml document with DOCTYPE but not declaration", () => {
            ...
            const openedDocument = new qubvscodemock.TextDocument("xml", "mock-uri", `<!DOCTYPE root>`);
            platform.openTextDocument(openedDocument);
        ...
        test("with xml document with declaration and DOCTYPE", () => {
            ...
            const openedDocument = new qubvscodemock.TextDocument("xml", "mock-uri", `<?xml version="1.0"?><!DOCTYPE root>`);
            platform.openTextDocument(openedDocument);
    ...
    suite("on document saved", () => {
        test("with non-xml document", () => {
            ...
            platform.saveTextDocument(new qubvscodemock.TextDocument("html", "mock-uri", "I'm not XML!"));
        });
        ...
        test("with xml document without declaration or DOCTYPE", () => {
            ...
            platform.saveTextDocument(new qubvscodemock.TextDocument("xml", "mock-uri", ""));
        });
        ...
        test("with xml document with declaration but not DOCTYPE", () => {
            ...
            platform.saveTextDocument(new qubvscodemock.TextDocument("xml", "mock-uri", `<?xml version="1.0" ?>`));
        });
        ...
        test("with xml document with DOCTYPE but not declaration", () => {
            ...
            platform.saveTextDocument(new qubvscodemock.TextDocument("xml", "mock-uri", `<!DOCTYPE root>`));
        });
        ...
        test("with xml document with declaration and DOCTYPE", () => {
            ...
            platform.saveTextDocument(new qubvscodemock.TextDocument("xml", "mock-uri", `<?xml version="1.0"?><!DOCTYPE root>`));
        });
    });
    ...
    suite("on document changed", () => {
        test("with non-xml document", () => {
            ...
            platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("html", "mock-uri", "I'm not XML!")));
        ...
        function documentChangedTest(documentText: string, insertIndex: number, insertText: string, expectedDocumentText: string, expectedCursorIndex: number): void {
            test(`with ${qub.escapeAndQuote(documentText)} and inserting ${qub.escapeAndQuote(insertText)} at index ${insertIndex}`, () => {
                ...
                platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("xml", "mock-uri", documentText)));
                assert.deepStrictEqual(platform.getCursorIndex(), 0);
    ...
    suite("on hover", () => {
        ...
        for (let i = -1; i < declarationText.length + 1; ++i) {
            test(`with ${qub.escapeAndQuote(declarationText)} at index ${i}`, () => {
                ...
                platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("xml", "C:/Mock/Folders/temp.xml", declarationText)));
        ...
        for (let i = -1; i < doctypeText.length + 1; ++i) {
            test(`with ${qub.escapeAndQuote(doctypeText)} at index ${i}`, () => {
                ...
                platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("xml", "C:/Mock/Folders/temp.xml", doctypeText)));
        ...
        for (let i = -1; i < rootElementText.length + 1; ++i) {
            test(`with ${qub.escapeAndQuote(rootElementText)} at index ${i}`, () => {
                ...
                platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("xml", "C:/Mock/Folders/temp.xml", rootElementText)));
    ...
    suite("on completions", () => {
        ...
        function completionTest(documentText: string, expectedCompletions: (index: number) => qubvscode.Completion[]): void {
            for (let i = -1; i < documentText.length + 1; ++i) {
                test(`with ${qub.escapeAndQuote(documentText)} at index ${i}`, () => {
                    const platform = new qubvscodemock.Platform();
                    const extension = new e.Extension(platform);

                    platform.setActiveTextEditor(new qubvscodemock.TextEditor(new qubvscodemock.TextDocument("xml", "C:/Mock/Folders/temp.xml", documentText)));
        ...
        completionTest(`<?`, (index: number) =>
            (2 === index) ? [new qubvscode.Completion("xml", new qub.Span(2, 0))] :
                []);
        completionTest(`<?x`, (index: number) =>
            (2 <= index && index <= 3) ? [new qubvscode.Completion("xml", new qub.Span(2, 1))] :
                []);
        completionTest("<a", (index: number) => []);
        completionTest("<!", (index: number) => []);
        completionTest("<@", (index: number) => []);
        completionTest("<?xml   ", (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 <= index) ? [new qubvscode.Completion("version", new qub.Span(index, 0))] :
                    []);
        completionTest("<?xml  version  ", (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 === index) ? [new qubvscode.Completion("version", new qub.Span(index, 0))] :
                    (7 <= index && index <= 14) ? [new qubvscode.Completion("version", new qub.Span(7, 7))] :
                        []);
        completionTest(`<?xml version="1.0" encoding  `, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 <= index && index <= 13) ? [new qubvscode.Completion("version", new qub.Span(6, 7))] :
                    (14 <= index && index <= 18) ? [new qubvscode.Completion(`"1.0"`, new qub.Span(14, 5))] :
                        (20 <= index && index <= 28) ? [new qubvscode.Completion("encoding", new qub.Span(20, 8))] :
                            []);
        completionTest(`<?xml version="1.0" encoding =  `, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 <= index && index <= 13) ? [new qubvscode.Completion("version", new qub.Span(6, 7))] :
                    (14 <= index && index <= 18) ? [new qubvscode.Completion(`"1.0"`, new qub.Span(14, 5))] :
                        (20 <= index && index <= 28) ? [new qubvscode.Completion("encoding", new qub.Span(20, 8))] :
                            (30 <= index) ? [new qubvscode.Completion(`"utf-8"`, new qub.Span(index, 0))] :
                                []);
        completionTest(`<?xml version="1.0" encoding=>`, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 <= index && index <= 13) ? [new qubvscode.Completion("version", new qub.Span(6, 7))] :
                    (14 <= index && index <= 18) ? [new qubvscode.Completion(`"1.0"`, new qub.Span(14, 5))] :
                        (20 <= index && index <= 28) ? [new qubvscode.Completion("encoding", new qub.Span(20, 8))] :
                            (29 === index) ? [new qubvscode.Completion(`"utf-8"`, new qub.Span(index, 0))] :
                                []);
        completionTest(`<?xml version="1.0" encoding="utf-8" standalone="yes" ?>`, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 <= index && index <= 13) ? [new qubvscode.Completion("version", new qub.Span(6, 7))] :
                    (14 <= index && index <= 18) ? [new qubvscode.Completion(`"1.0"`, new qub.Span(14, 5))] :
                        (20 <= index && index <= 28) ? [new qubvscode.Completion("encoding", new qub.Span(20, 8))] :
                            (29 <= index && index <= 35) ? [new qubvscode.Completion(`"utf-8"`, new qub.Span(29, 7))] :
                                (37 <= index && index <= 47) ? [new qubvscode.Completion("standalone", new qub.Span(37, 10))] :
                                    (48 <= index && index <= 52) ? [new qubvscode.Completion(`"no"`, new qub.Span(48, 5)), new qubvscode.Completion(`"yes"`, new qub.Span(48, 5))] :
                                        []);
        completionTest(`<?xml  version=  encoding=  standalone=  ?>`, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 === index) ? [new qubvscode.Completion("version", new qub.Span(6, 0))] :
                    (7 <= index && index <= 14) ? [new qubvscode.Completion("version", new qub.Span(7, 7))] :
                        (15 <= index && index <= 16) ? [new qubvscode.Completion(`"1.0"`, new qub.Span(index, 0))] :
                            (17 <= index && index <= 25) ? [new qubvscode.Completion("encoding", new qub.Span(17, 8))] :
                                (26 <= index && index <= 27) ? [new qubvscode.Completion(`"utf-8"`, new qub.Span(index, 0))] :
                                    (28 <= index && index <= 38) ? [new qubvscode.Completion("standalone", new qub.Span(28, 10))] :
                                        (39 <= index && index <= 40) ? [new qubvscode.Completion(`"no"`, new qub.Span(index, 0)), new qubvscode.Completion(`"yes"`, new qub.Span(index, 0))] :
                                            []);
        completionTest(`<?xml  spam =  "test"  ?   >`, (index: number) =>
            (2 <= index && index <= 5) ? [new qubvscode.Completion("xml", new qub.Span(2, 3))] :
                (6 === index) ? [new qubvscode.Completion("version", new qub.Span(6, 0))] :
                    (7 <= index && index <= 11) ? [new qubvscode.Completion("version", new qub.Span(7, 4))] :
                        (22 <= index && index <= 23) ? [new qubvscode.Completion("encoding", new qub.Span(index, 0))] :
                            []);
        ...
        completionTest(`<rootElement><childElement/></rootElement>`, (index: number) =>
            (30 <= index && index <= 41) ? [new qubvscode.Completion("rootElement", new qub.Span(30, 11))] :
                []);
        completionTest(`<rootElement><childElement/></>`, (index: number) =>
            (30 === index) ? [new qubvscode.Completion("rootElement", new qub.Span(30, 0))] :
                []);
